    ...
    <Container>
      <Content>
        ...
        <p>
          ...
          desenvolvido na Next Level Week (NLW), uma evento em que um projeto é
          desenvolvido do total zero em apenas uma semana. Esse evento é
          promovido pela Rocketseat, uma startup sensacional que tem feito
          milhares de alunos pelo mundo afora!
        </p>

        <p>
          O --- se originou da terceira edição da NLW. Na primeira, fiz a trilha
          iniciante. Na segunda, fiz a trilha avançada, e vi outras pessoas
          fazendo as suas próprias versões do projeto principal. Quis fazer o
          meu projeto personalizado também, mas como eu estava iniciando com
          React, fiz apenas personalizações simples e pensei em fazer minha
          aplicação personalizada para a próxima edição.
        </p>

        <p>
          A próxima edição chegou, e agora estou conseguindo fazer tudo o que eu
          queria! Estou muito feliz por poder concluir o projeto com boas
